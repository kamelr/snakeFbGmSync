	...
	public void create() {
		...
		btnNext.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					try {
						myService.setUserCredentials(
								txtUsernameGmail.getText(), txtPasswordGmail
										.getText());
					...
					for (User friend : friends) {
						ContactEntry gmailContact = gmailClient
								.getContact(friend.getLastName() + "_"
										+ friend.getFirstName());

						if (gmailContact == null) {
							gmailContact = gmailClient.getContact(friend
									.getFirstName()
									+ "_" + friend.getLastName());
						}

						if (gmailContact != null) {
							countMatched++;

							if (gmailContact.getContactPhotoLink().getEtag() == null
									&& friend.getPicBig() != null) {
							...
							System.out.println(friend.getLastName() + "_"
									+ friend.getFirstName());
						} else {
							countNotMatched++;
							System.err.println(friend.getLastName() + "_"
									+ friend.getFirstName());
						}
					}
				...
				System.out.println("not matched" + countNotMatched
